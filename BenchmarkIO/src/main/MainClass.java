...
public class MainClass {
	public static void main(String[] args) throws Exception{
		...
		IO.println("JAVA IO - Demorou "+(t1_fim - t1_ini)+"ms");
		
		
		
		// Java NIO usando FileChanel
		long t2_ini, t2_fim;
		...
		IO.println("JAVA NIO Channel- Demorou "+(t2_fim - t2_ini)+"ms");
		...
		IO.println("JAVA NIO2 ReadAllLines- Demorou "+(t3_fim - t3_ini)+"ms");
